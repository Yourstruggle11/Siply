...
export const AI_INSIGHT_PROMPT_VERSION = 2;
export const AI_HISTORY_ARTIFACT_PROMPT_VERSION = 2;
...
export const AI_HISTORY_PRESENTATION_STORAGE_KEY = "siply:ai_history_presentation:v1";
...
export const AI_HISTORY_PHASE_BOUNDARIES = [0.4, 0.75] as const;
